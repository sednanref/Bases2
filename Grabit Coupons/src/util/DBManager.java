...
public class DBManager {
	...
	public void insertionAndQueries(){
		...
		try {
			...
			/*Query section*/
			/*This section is commented for this release. (release 4)*/
			/*
		...
		updateSales(sale1, sale2);
		
		sessionFactory.close();
	}

	 public static void updateSales(Sale sale1, Sale sale2){
			...
			- If the date provided to the doAction is after the
		 	...
		 	/*Creation of the SessionFactory, the session and the transaction.*/
			SessionFactory sessionFactory = new Configuration().configure().buildSessionFactory();
			Session session = sessionFactory.openSession();
			...
			//Date todayDate3 = new Date(2014 - 1900,3,17);  //	17/04/2014
			//Date todayDate4 = new Date(2014 - 1900,4,17);  //	17/05/2015
